...
sum_table.write('File_name'.ljust(50) + 'Original values'.rjust(15) + \
                'Erel(kJ)'.rjust(22) + 'Erel(kcal)'.rjust(16) + '\n')

sum_table.write(''.ljust(140, '=') + '\n')
for k, v in some_data.items():
    ...
    out_line =  k.ljust(50) + v.rjust(15) + '\t' + str(v_kcal.__round__(3)).rjust(15) + \
