...
### Подготовка файла для поиска и наименований траектрорий
#a = pd.read_csv('sorted_df.csv') #чтение ранее созданного csv, где фрейм с одним столбцом
#print(a.shape)
#a.drop(labels = [0,1], axis = 0, inplace = True) #удаляю лишние строки
#a.reset_index(drop=True, inplace= True )
#a.info()
#print(a)
#print(a.shape)
#a.to_csv('a.csv', sep=' ')
#переразбиение столбцов
#new_a = a[' amount xyz_num'].str.split(' ', expand = True)
#print(new_a)
#print(new_a.shape)
#new_a.to_csv('for_gen.csv', sep=' ', index=False, )
...
#print(pd.read_csv('sorted_df.csv', on_bad_lines='skip'))




#sorted_df.to_dict('sorted_df', orient=’dict’, into=)

#sorted_df = new_df.groupby(['brutto']).agg('sum').round(10)
#df2 = new_df.agg({'brutto' : ['count'],
#                  'amount' : ['sum']})
#new_df['sum_amount'] = [new_df.loc[new_df['brutto'] == i, 'brutto'].sum() for i in new_df['brutto']]

#new_df.to_excel('new_df2.xlsx')

#agg_sum = {'amount': ['sum']}

#'at1', 'at_q1', 'at2', 'at_q2', 'at3', 'at_q3', 'at4', 'at_q4', 'at5', 'at_q5'

#print(new_df['amount'].apply(type))
